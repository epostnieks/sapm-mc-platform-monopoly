#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Platform Monopoly / Gatekeeper Ratchet
======================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Platform Monopoly (Gatekeeper Ratchet).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "platform_monopoly",
    "domain_name": "Platform Monopoly",
    "theorem": "Gatekeeper Ratchet",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 158.0,
    "channels": {
        "C1_supracompetitive_pricing": {
            "dist": "normal",
            "low": 120.0,
            "mid": 195.0,
            "high": 270.0,
            "weight": 0.2,
            "description": "CMA ROCE-WACC spread: search ad overcharge $35B + social media $39.5B + app store $80B + cloud egress $42.5B"
        },
        "C2_innovation_kill_zone": {
            "dist": "lognormal",
            "low": 60.0,
            "mid": 120.0,
            "high": 180.0,
            "weight": 0.12,
            "description": "K-R-Z 46% VC suppression \u00d7 3x innovation multiplier + killer acquisition project termination"
        },
        "C3_data_extraction_privacy": {
            "dist": "lognormal",
            "low": 120.0,
            "mid": 240.0,
            "high": 360.0,
            "weight": 0.24,
            "description": "WTA $960/yr \u00d7 250M adults; cross-checked via Meta ARPU and macro ad-spend"
        },
        "C4_publisher_creator_destruction": {
            "dist": "lognormal",
            "low": 45.0,
            "mid": 85.0,
            "high": 125.0,
            "weight": 0.09,
            "description": "JCPA $11B US journalism + $40B global publisher deficit + $20B local news + $14B creator misallocation"
        },
        "C5_small_business_dependency": {
            "dist": "normal",
            "low": 120.0,
            "mid": 200.0,
            "high": 280.0,
            "weight": 0.2,
            "description": "ILSR Amazon $185B extraction: $100B monopoly rent + $50B mandatory ad tax + $35B MFN + $15B switching"
        },
        "C6_governance_regulatory_capture": {
            "dist": "lognormal",
            "low": 80.0,
            "mid": 150.0,
            "high": 220.0,
            "weight": 0.15,
            "description": "Blocked legislation $80B + institutional capture $30B + democratic integrity $25B + subsidy extraction $15B"
        }
    },
    "impossibility_floor": 2.8
}
